...
const publicationsData = [
  {
    ...
    longDescription: `
      ...
      <p class="mb-4 text-base leading-relaxed">This study maps Indonesia's critical economic dependencies, assesses their potential risks, and proposes policy recommendations to enhance resilience. As a caveat, 
