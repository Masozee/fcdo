        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 max-w-6xl mx-auto">
          ...
          <div className="bg-gray-50 dark:bg-gray-800 p-8 rounded-lg">
            <div className="flex items-center mb-6">
              ...
              <div>
                ...
                <p className="text-sm text-gray-500 dark:text-gray-400">Director of Global Trade, TechCorp</p>
              </div>
            </div>
          ...
          <div className="bg-gray-50 dark:bg-gray-800 p-8 rounded-lg">
            <div className="flex items-center mb-6">
              ...
              />
              <div>
                <h3 className="font-medium text-gray-900 dark:text-white">Marcus Rodriguez</h3>
                <p className="text-sm text-gray-500 dark:text-gray-400">Supply Chain Manager, Global Logistics</p>
              </div>
            </div>
            <blockquote className="text-gray-600 dark:text-gray-300 mb-6">
          ...
          <div className="bg-gray-50 dark:bg-gray-800 p-8 rounded-lg">
            <div className="flex items-center mb-6">
              ...
              />
              <div>
                <h3 className="font-medium text-gray-900 dark:text-white">Emily Zhang</h3>
                <p className="text-sm text-gray-500 dark:text-gray-400">Trade Analyst, AgriTech Solutions</p>
              </div>
            </div>
            <blockquote className="text-gray-600 dark:text-gray-300 mb-6">
